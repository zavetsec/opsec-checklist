...
| **Hardware tokens** | YubiKey alternatives: Аладдин JaCarta (Russia, FSTEC-certified), Tumar (Kazakhstan, NCA) for FIDO2/U2F; Яндекс Ключ as TOTP alternative |
| **Financial OPSEC** | Cash first; virtual cards (Tinkoff/Alfa) = fraud protection only, NOT anonymity; real anonymity via Monero through RetoSwap or Bisq; LocalMonero closed November 2024 |
...
| **Financial OPSEC** | Cash as the primary anonymous payment method; Privacy.com (US) for merchant-separated virtual cards; Revolut/Wise (EU); Monero for actual anonymity |
